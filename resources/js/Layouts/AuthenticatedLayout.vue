    ...
    <div>
        <div class="min-h-screen bg-gray-100">
            ...
            <div v-if="$page.props.flash.message" class="relative p-4 mb-4 text-sm flex justify-between" :class="{
                ...
                'text-red-700 bg-red-100 dark:bg-red-400 dark:text-red-800': $page.props.flash.type === 'destroy',
                'text-blue-700 bg-blue-100 dark:bg-blue-400 dark:text-blue-800': $page.props.flash.type === 'restore',
                'hidden': isHidden
            }" role="alert">
